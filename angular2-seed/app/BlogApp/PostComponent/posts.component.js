System.register(['angular2/core', 'angular2/http', '../Service/post.service', '../Service/user.service', 'angular2/router', '../Component/spinner.component', '../Component/paginition.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, post_service_1, user_service_1, router_1, spinner_component_1, paginition_component_1;
    var PostComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (paginition_component_1_1) {
                paginition_component_1 = paginition_component_1_1;
            }],
        execute: function() {
            PostComponent = (function () {
                ...
                PostComponent.prototype.loadPosts = function (filter) {
                    ...
                    this._postService.getPosts(filter)
                        ...
                        null,
                            function () { _this.postLoading = false; };
                    });
                };
                ...
                PostComponent = __decorate([
                    core_1.Component({
                        selector: 'posts',
                        templateUrl: 'app/BlogApp/PostComponent/posts.component.html',
                        styles: ["\n            .posts li { cursor: default; }\n            .posts li:hover { background: #ecf0f1; } \n            .list-group-item.active, \n             .list-group-item.active:hover, \n             .list-group-item.active:focus { \n                         background-color: #ecf0f1;\n                         border-color: #ecf0f1; \n                         color: #2c3e50;\n             }\n    "],
                        directives: [router_1.RouterLink, spinner_component_1.SpinnerComponent, paginition_component_1.PaginationComponent],
